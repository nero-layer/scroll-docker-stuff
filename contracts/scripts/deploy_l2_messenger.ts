...
async function main() {
  ...
  const queue = "0x5FbDB2315678afecb367f032d93F642f64180aa3"//process.env.L2_MESSAGE_QUEUE_ADDR!;
  if (!addressFile.get("L2ScrollMessenger.implementation")) {
    ...
    const impl = await L2ScrollMessenger.deploy(container, queue); // queue
